...
DEF SET_PAL_BATTLE_BLACK         EQU $00
DEF SET_PAL_BATTLE               EQU $01
DEF SET_PAL_TOWN_MAP             EQU $02
DEF SET_PAL_STATUS_SCREEN        EQU $03
DEF SET_PAL_POKEDEX              EQU $04
DEF SET_PAL_SLOTS                EQU $05
DEF SET_PAL_TITLE_SCREEN         EQU $06
DEF SET_PAL_NIDORINO_INTRO       EQU $07
DEF SET_PAL_GENERIC              EQU $08
DEF SET_PAL_OVERWORLD            EQU $09
DEF SET_PAL_PARTY_MENU           EQU $0A
DEF SET_PAL_POKEMON_WHOLE_SCREEN EQU $0B
DEF SET_PAL_GAME_FREAK_INTRO     EQU $0C
DEF SET_PAL_TRAINER_CARD         EQU $0D
DEF UPDATE_PARTY_MENU_BLK_PACKET EQU $FC
